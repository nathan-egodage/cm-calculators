...
const PhpContractorGpCalculator = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-6 max-w-6xl">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-2xl font-bold mb-2">PHP Contractor GP Calculator</h1>
        <p className="text-sm text-gray-500 dark:text-gray-400">Calculate gross profit for Philippine contractors</p>
      </div>
            ...
            <table className="w-full">
              <tbody>
                <tr className={`border-b ${darkMode ? 'border-gray-700' : 'border-gray-200'}`}>
                  <td className="px-4 py-3 text-sm">PHP Monthly Salary (160 hours)</td>
