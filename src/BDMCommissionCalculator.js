...
const BDMCommissionCalculator = () => {
  ...
  const fixedBonuses = [
    { tierMin: 1, gpMin: 0.33, gpMax: 0.34, bonus: 2500 },
    { tierMin: 1, gpMin: 0.34, gpMax: 0.35, bonus: 3000 },
...
export default BDMCommissionCalculator;